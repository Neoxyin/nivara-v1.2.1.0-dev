...
export const INITIAL_CIRCLES: SupportCircle[] = [
  ...
  },
  {
    ...
    description: 'Navigating campus life away from home for the first time. Share experiences and build connection in a confidential circle.',
  ...
  },
  {
    ...
    description: 'For students navigating internship applications, interviews, and career uncertainty. Ground yourself with peer encouragement.',
