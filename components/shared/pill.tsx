...
interface PillProps { children: ReactNode; tone?: 'default'|'accent'|'warm'|'plum'; }
export function Pill({children,tone='default'}:PillProps){
 ...
 return <span className={`inline-flex items-center rounded-full px-2.5 py-1 font-mono-ui text-[10px] uppercase tracking-[.08em] ${tones[tone]}`}>{children}</span>
}
